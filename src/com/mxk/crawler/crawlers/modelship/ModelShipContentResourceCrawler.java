package com.mxk.crawler.crawlers.modelship;
	...
	public List<? extends BaseResource> crawler(String url) {
		...
		try{
			...
			if(!imgs.isEmpty()){
				...
				content.setMultiData(SiteInfo.CHINIA_TW.getCode());
				content.setHit(String.valueOf(3000 + (int)(Math.random()*1000)));
				...
				String info = htmlInfoManage(comms.html());
				content.setInfo(StringUtil.regxpForHtml(info,"").trim());
